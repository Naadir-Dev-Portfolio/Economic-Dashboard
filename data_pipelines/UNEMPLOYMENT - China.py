#!/usr/bin/env python3
"""
Metric: China Unemployment Rate via FRED API

Definition:
  The unemployment rate measures the percentage of the Chinese labor force 
...
When to worry:
  ...
  it indicates heightened economic stress.
"""
...
SERIES       = "LRHUTTTTCNM156S"  # FRED code for China unemployment rate (OECD via FRED)
START_DATE   = "1970-01-01"
END_DATE     = date.today().strftime("%Y-%m-%d")
OUT_DIR      = "data"
OUT_FILE     = os.path.join(OUT_DIR, "chn_unemployment_rate.xlsx")
SHEET_NAME   = "Unemployment_CHN"
...
with pd.ExcelWriter(OUT_FILE, engine="xlsxwriter", datetime_format="yyyy-mm-dd") as writer:
    ...
    chart.set_title({"name": "China Unemployment Rate"})
